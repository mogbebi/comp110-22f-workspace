...
# tuples, because they are squenced, are 0-indexed
...
# An examle of using the default parameter step
# where the default step is 1
another_grange: range = range(0, 10)

# If you only pass one argument to range, it specifies the
# stop marker and start is 0 by default
...
# Range is often used to write for loosp where iteration patterns aren't consecutive.
print("Every other")
